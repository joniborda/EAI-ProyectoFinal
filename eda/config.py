...
class Settings:
    ...
    ad_spends_table: str = os.getenv("AD_SPENDS_TABLE", "forecasts")
    events_table: str = os.getenv("EVENTS_TABLE", "events")
    orders_date_col: str = os.getenv("ORDERS_DATE_COL", "created")
    events_start_date_col: str = os.getenv("EVENTS_START_DATE_COL", "startDate")
